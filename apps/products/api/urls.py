...
from apps.products.api.views.products_views import ProductListAPIView, CreateProductAPIView
...
urlpatterns = [
    ...
    path('create_product/', CreateProductAPIView.as_view(), name='Create Product')
]
